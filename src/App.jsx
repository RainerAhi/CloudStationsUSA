  ...
  return (
    <div className={`loading-screen ${active ? "" : "loading-screen--hidden"}`}>
      <div className="loading-screen__container">
        <h1 className="loading-screen__title animated-text">Cloud Stations</h1>
      ...
      <>
        ...
        <div className="nav">
          <div className="left-content">
            <h1 className="small-description bold black" >Cloud Stations</h1>
          </div>
          <div className="right-content">
            <Link to="/" className="small-text navigation-text white">
              <h1 className="small-description navigation-text black" >Home</h1>
            </Link>
